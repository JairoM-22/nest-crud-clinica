...
export class SeedService {
  ...
  async runSeed() {
    ...
    try {
      ...
      await queryRunner.query('TRUNCATE TABLE "receta", "cita", "especialista", "paciente", "doctor", "especialidad" RESTART IDENTITY CASCADE;');
      // Insert Paciente
      ...
      await queryRunner.query(`
        ...
        (42, 12, 7, '2024-02-29', '10:30:00', 'Revisión de piel', 'cancelada'),
        ...
        (61, 1, 1, '2024-03-01', '09:00:00', 'Control de presión arterial', 'realizada'),
        (62, 2, 2, '2024-03-02', '10:30:00', 'Revisión de problemas dermatológicos', 'realizada'),
        (63, 3, 3, '2024-03-03', '11:00:00', 'Consulta por dolores de cabeza', 'realizada'),
        (64, 4, 4, '2024-03-04', '14:00:00', 'Revisión de la vista', 'realizada'),
        (65, 5, 5, '2024-03-05', '15:30:00', 'Problema de sinusitis', 'realizada'),
        (66, 6, 6, '2024-03-06', '09:30:00', 'Molestias digestivas', 'realizada'),
        (67, 7, 7, '2024-03-07', '13:00:00', 'Tosecilla persistente', 'realizada'),
        (68, 8, 8, '2024-03-08', '10:00:00', 'Control de diabetes', 'realizada'),
        (69, 9, 9, '2024-03-09', '14:30:00', 'Problema urinario', 'realizada'),
        (70, 10, 10, '2024-03-10', '11:30:00', 'Consulta de ansiedad', 'realizada'),
        (71, 11, 11, '2024-03-11', '09:00:00', 'Revisión prenatal', 'realizada'),
        (72, 12, 12, '2024-03-12', '15:00:00', 'Lesión en rodilla', 'realizada'),
        (73, 13, 13, '2024-03-13', '10:30:00', 'Dolor en articulaciones', 'realizada'),
        (74, 14, 1, '2024-03-14', '11:00:00', 'Seguimiento cardiaco', 'realizada'),
        (75, 15, 2, '2024-03-15', '09:30:00', 'Tratamiento de acné', 'realizada'),
        (76, 16, 3, '2024-03-16', '14:00:00', 'Migrañas frecuentes', 'realizada'),
        (77, 17, 4, '2024-03-17', '10:00:00', 'Consulta oftalmológica', 'realizada'),
        (78, 18, 5, '2024-03-18', '13:30:00', 'Otitis media', 'realizada'),
        (79, 19, 6, '2024-03-19', '09:00:00', 'Reflujo gástrico', 'realizada'),
        (80, 20, 7, '2024-03-20', '15:00:00', 'Control de asma', 'realizada'),
        (81, 21, 8, '2024-03-21', '10:30:00', 'Control de tiroides', 'realizada'),
        (82, 22, 9, '2024-03-22', '14:00:00', 'Consulta urológica', 'realizada'),
        (83, 23, 10, '2024-03-23', '11:00:00', 'Seguimiento psiquiátrico', 'realizada'),
        (84, 24, 11, '2024-03-24', '09:30:00', 'Revisión ginecológica', 'realizada'),
        (85, 25, 12, '2024-03-25', '15:00:00', 'Evaluación de fractura', 'realizada'),
        (86, 26, 13, '2024-04-06', '10:30:00', 'Artritis reumatoide', 'pendiente'),
        (87, 27, 14, '2024-04-07', '13:00:00', 'Consulta oncológica', 'pendiente'),
        (88, 28, 15, '2024-04-08', '09:00:00', 'Control pediátrico', 'pendiente'),
        (89, 29, 1, '2024-04-09', '14:00:00', 'Revisión de colesterol, dolor', 'pendiente'),
        (90, 30, 2, '2024-04-10', '11:00:00', 'Tratamiento de verrugas', 'pendiente'),
        (91, 1, 16, '2024-04-11', '10:00:00', 'Consulta cardiaca', 'pendiente'),
        (92, 2, 17, '2024-04-12', '15:30:00', 'Revisión respiratoria', 'pendiente'),
        (93, 3, 18, '2024-04-13', '09:30:00', 'Consulta dermatológica', 'pendiente'),
        (94, 4, 19, '2024-04-14', '13:00:00', 'Problema urológico', 'pendiente'),
        (95, 5, 20, '2024-04-15', '11:00:00', 'Revisión ginecológica', 'pendiente'),
        (96, 6, 1, '2024-04-16', '09:00:00', 'Cardiología seguimiento', 'pendiente'),
        (97, 7, 2, '2024-04-17', '14:30:00', 'Revisión dermatológica', 'pendiente'),
        (98, 8, 3, '2024-04-18', '10:00:00', 'Neuro seguimiento', 'pendiente'),
        (99, 9, 4, '2024-04-19', '11:30:00', 'Oftalmología control', 'pendiente'),
        (100, 10, 5, '2024-04-20', '15:00:00', 'ORL revisión', 'pendiente'),
        (101, 11, 6, '2024-02-28', '09:00:00', 'Control de presión', 'cancelada'),
        (102, 12, 7, '2024-02-29', '10:30:00', 'Revisión de piel', 'cancelada'),
        (103, 13, 8, '2024-03-01', '14:00:00', 'Consulta neurológica', 'cancelada'),
        (104, 14, 9, '2024-03-02', '15:30:00', 'Examen oftalmológico', 'cancelada'),
        (105, 15, 10, '2024-03-03', '11:00:00', 'Revisión ORL', 'cancelada'),
        (106, 16, 11, '2024-03-04', '09:30:00', 'Gastroenterología', 'cancelada'),
        (107, 17, 12, '2024-03-05', '13:00:00', 'Neumología', 'cancelada'),
        (108, 18, 13, '2024-03-06', '10:00:00', 'Endocrinología', 'cancelada'),
        (109, 19, 14, '2024-03-07', '14:30:00', 'Urología', 'cancelada'),
        (110, 20, 15, '2024-03-08', '11:30:00', 'Psiquiatría', 'cancelada'),
        (111, 21, 1, '2024-03-09', '09:00:00', 'Ginecología', 'cancelada'),
        (112, 22, 2, '2024-03-10', '15:00:00', 'Traumatología', 'cancelada'),
        (113, 23, 3, '2024-03-11', '10:30:00', 'Reumatología', 'cancelada'),
        (114, 24, 4, '2024-03-12', '11:00:00', 'Oncología', 'cancelada'),
        (115, 25, 5, '2024-03-13', '09:30:00', 'Pediatría', 'cancelada'),
        (116, 26, 6, '2024-03-14', '14:00:00', 'Cardiología', 'cancelada'),
        (117, 27, 7, '2024-03-15', '10:00:00', 'Dermatología', 'cancelada'),
        (118, 28, 8, '2024-03-16', '13:30:00', 'Neurología', 'cancelada'),
        (119, 29, 9, '2024-03-17', '09:00:00', 'Oftalmología', 'cancelada'),
        (120, 30, 10, '2024-03-18', '15:00:00', 'Otorrinolaringología', 'cancelada');
      `);
      // Insert Receta
      await queryRunner.query(`
        ...
        (15, 11, 'Vitamina prenatales', 'Completo', 'Tomar un comprimido cada mañana', '2024-03-11 09:30:00'),
        ...
        (31, 1, 'Enalapril', '10mg', 'Tomar una tableta cada día por la mañana', '2024-03-01 09:30:00'),
        (32, 1, 'Atorvastatina', '20mg', 'Tomar una tableta cada noche', '2024-03-01 09:30:00'),
        (33, 2, 'Clindamicina', '150mg', 'Aplicar crema tres veces al día', '2024-03-02 11:00:00'),
        (34, 3, 'Sumatriptán', '50mg', 'Tomar al inicio del dolor de cabeza, máximo 2 veces por semana', '2024-03-03 11:30:00'),
        (35, 3, 'Paracetamol', '500mg', 'Tomar cada 6 horas si es necesario', '2024-03-03 11:30:00'),
        (36, 4, 'Lubricante ocular', 'Gotas', 'Aplicar 2 gotas en cada ojo 3 veces al día', '2024-03-04 14:30:00'),
        (37, 5, 'Mometasona', 'Spray nasal', 'Aplicar 2 sprays en cada fosa nasal una vez al día', '2024-03-05 16:00:00'),
        (38, 5, 'Loratadina', '10mg', 'Tomar una tableta cada día', '2024-03-05 16:00:00'),
        (39, 6, 'Omeprazol', '20mg', 'Tomar una cápsula cada mañana antes del desayuno', '2024-03-06 10:00:00'),
        (40, 6, 'Metoclopramida', '10mg', 'Tomar media tableta 30 minutos antes de las comidas', '2024-03-06 10:00:00'),
        (41, 7, 'Bromhexina', '8mg', 'Tomar una tableta 3 veces al día', '2024-03-07 13:30:00'),
        (42, 8, 'Metformina', '850mg', 'Tomar una tableta dos veces al día con las comidas', '2024-03-08 10:30:00'),
        (43, 9, 'Tamsulosina', '0.4mg', 'Tomar una cápsula cada noche', '2024-03-09 15:00:00'),
        (44, 10, 'Sertralina', '50mg', 'Tomar una tableta cada mañana', '2024-03-10 12:00:00'),
        (45, 11, 'Vitamina prenatales', 'Completo', 'Tomar un comprimido cada mañana', '2024-03-11 09:30:00'),
        (46, 12, 'Ibuprofeno', '400mg', 'Tomar cada 8 horas durante 5 días', '2024-03-12 15:30:00'),
        (47, 12, 'Diclofenaco', 'Gel', 'Aplicar localmente 3 veces al día', '2024-03-12 15:30:00'),
        (48, 13, 'Glucosamina', '1500mg', 'Tomar un comprimido al día', '2024-03-13 11:00:00'),
        (49, 14, 'Amlodipina', '5mg', 'Tomar una tableta cada día', '2024-03-14 11:30:00'),
        (50, 15, 'Peróxido de benzoilo', 'Crema 5%', 'Aplicar una vez al día por la noche', '2024-03-15 10:00:00'),
        (51, 16, 'Propranolol', '80mg', 'Tomar una tableta cada 12 horas', '2024-03-16 14:30:00'),
        (52, 17, 'Timolol', 'Gotas 0.5%', 'Aplicar una gota en cada ojo dos veces al día', '2024-03-17 10:30:00'),
        (53, 18, 'Amoxicilina', '500mg', 'Tomar una cápsula cada 8 horas durante 7 días', '2024-03-18 14:00:00'),
        (54, 19, 'Ranitidina', '150mg', 'Tomar una tableta dos veces al día', '2024-03-19 09:30:00'),
        (55, 20, 'Albuterol', 'Inhalador', 'Usar 2 inhalaciones cada 4-6 horas según sea necesario', '2024-03-20 15:30:00'),
        (56, 21, 'Levotiroxina', '75mcg', 'Tomar una tableta cada mañana en ayunas', '2024-03-21 11:00:00'),
        (57, 22, 'Finasterida', '1mg', 'Tomar una tableta cada día', '2024-03-22 14:30:00'),
        (58, 23, 'Paroxetina', '20mg', 'Tomar una tableta cada mañana', '2024-03-23 11:30:00'),
        (59, 24, 'Hierro', '325mg', 'Tomar una tableta cada día con jugo de naranja', '2024-03-24 10:00:00'),
        (60, 25, 'Naproxeno', '500mg', 'Tomar una tableta cada 8-12 horas con alimentos', '2024-03-25 15:30:00')
      `);
